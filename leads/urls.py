...
urlpatterns = [
    ...
    path(
        "upload/random-agent/",
        views.upload_leads_with_random_agent,
        name="leads-upload-random",
    ),
    path(
        "upload/select-agent/",
        views.upload_leads_with_selected_agent,
    ...
    path(
        ...
        views.delete_selected_leads,
        name="delete-selected-leads",
    ),
    path(
        "assign-selected-leads",
        views.assign_selected_leads,
        name="assign-selected-leads",
    ),
    path(
        "assign-selected-leads-randomly",
        views.assign_selected_leads_randomly,
    ...
    path(
        "sheets/<int:pk>/delete", views.SheetDeleteView.as_view(), name="delete-sheet"
    ),
    # tags
    path("add-tag/", views.TagCreateView.as_view(), name="add-tag"),
    path("tags/<int:pk>/delete/", views.TagDeleteView.as_view(), name="delete-tag"),
    # stats
    path("stats/", views.StatsListView.as_view(), name="stats_list"),
    path("stats/filter", views.StatsFilterView.as_view(), name="stats_filter"),
    # stats
